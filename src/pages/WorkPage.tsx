...
const videoPortfolio = [
  {
    ...
    creator: "@nahushpatel",
    description: "High-speed commercial shot focusing on culinary precision and smooth motion. 🍳",
    likes: "3.2K",
    comments: "142",
    shares: "520",
    shouldRotate: true,
  },
  {
    ...
    creator: "@nahushpatel",
    description: "Atmospheric scene study with dramatic lighting and cinematic composition. ✨",
    likes: "2.8K",
    comments: "98",
    shares: "215",
    shouldRotate: true,
  },
  {
    ...
    creator: "@nahushpatel",
    description: "Capturing the essence of daily life with a modern, high-end aesthetic. 🌿",
    likes: "4.1K",
    comments: "256",
    shares: "890",
    shouldRotate: true,
  },
  {
    ...
    creator: "@nahushpatel",
    description: "Exploring urban landscapes and architectural details through a creative lens. 🏙️",
    likes: "5.4K",
    comments: "310",
    shares: "1.2K",
    shouldRotate: true,
  },
  {
    ...
    creator: "@nahushpatel",
    description: "Deep dive into cultural stories and local narratives. Powerful storytelling. 📖",
    likes: "8.9K",
    comments: "1.5K",
    shares: "3.4K",
    shouldRotate: false,
  },
  {
    ...
    creator: "@nahushpatel",
    description: "Elegant brand showcase with smooth transitions and premium grading. 💎",
    likes: "6.7K",
    comments: "420",
    shares: "950",
    shouldRotate: true,
  },
  {
    ...
    creator: "@nahushpatel",
    description: "Fast-paced motion exploration with dynamic cuts and rhythmic energy. ⚡",
    likes: "3.9K",
    comments: "185",
    shares: "460",
    shouldRotate: true,
  ...
  },
  {
    ...
    creator: "@nahushpatel",
    description: "A visual journey across contrasting environments and cinematic moods. 🌎",
    likes: "7.2K",
    comments: "530",
    shares: "1.1K",
    shouldRotate: true,
    ...
    <div className="relative w-full h-[100dvh] md:h-full snap-start shrink-0 flex items-center justify-center bg-black">
      ...
      >
        <video
          ref={videoRef}
          src={video.videoUrl}
          className={`absolute inset-0 object-cover transition-transform duration-500 ${video.shouldRotate
              ? "w-[177.7dvh] h-[100dvh] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rotate-90"
              : "w-full h-full"
            }`}
          loop
          muted={false}
